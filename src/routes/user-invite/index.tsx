...
function Overview() {
  ...
  const data = useMemo(
    () => [
      {
        title: t("Total user"),
        stats: me?.affiliateData?.totalReferrals,
        description: t(
      ...
      },
      {
        ...
        stats: formatCurrency(
          Math.abs(me?.affiliateData?.totalEarned || 0),
        ),
        description: t(
      ...
      },
      {
        ...
        stats: formatCurrency(
          Math.abs(me?.affiliateData?.ratio || 0),
        ),
        description: t(
    ...
    [
      me?.affiliateData?.ratio,
      me?.affiliateData?.totalEarned,
      me?.affiliateData?.totalReferrals,
      t,
    ],
  );
  ...
  return (
    // TODO: The data in the backend is currently hardcoded, make it visible after fixing the backend."
    <Box hidden>
      <Flex
        justify={"space-between"}
        align={{
...
export function RebatesHistory() {
  const t = useSPETranslation();
  const { referrals, fetch } = affiliateStore();
